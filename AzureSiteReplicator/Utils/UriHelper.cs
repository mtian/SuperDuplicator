...
namespace AzureSiteReplicator.Utils
{
    static class UriHelper
    {
        ...
        public static string GetWebSitePublishXmlUri(string webSpace, string siteName)
        {
            PublishProfile profile = PublishProfile.Current;
            return String.Format("{0}/{1}/services/webspaces/{2}/sites/{3}/publishxml",
                profile.GetUrl(),
                profile.GetSubscriptionId(),
                webSpace,
                siteName);
