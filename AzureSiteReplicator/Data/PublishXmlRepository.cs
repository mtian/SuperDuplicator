...
{
    public class PublishXmlRepository : IPublishXmlRepository
    {
        ...
        {
            string pfx = System.Environment.ExpandEnvironmentVariables(@"%SystemDrive%\home\.azure\azuretool.pfx");
            ...
            foreach (WebSite site in WebSite.GetAllAsync().Result)
            {
                ...
                sites.Add(new Site(path) { WebSpace = site.WebSpace });
            }
